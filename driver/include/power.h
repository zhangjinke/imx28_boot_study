...
struct imx28_power_regs {
    struct imx28_reg_32  ctrl;
    struct imx28_reg_32  ctrl5v;
    struct imx28_reg_32  minpwr;
    struct imx28_reg_32  charge;
    struct normal_reg_32 vdddctrl;
    struct normal_reg_32 vddactrl;
    struct normal_reg_32 vddioctrl;
    struct normal_reg_32 vddmemctrl;
    struct normal_reg_32 dcdc4p2;
    struct normal_reg_32 misc;
    struct normal_reg_32 dclimits;
    struct imx28_reg_32  loopctrl;
    struct normal_reg_32 sts;
    struct imx28_reg_32  speed;
    struct normal_reg_32 battmonitor;
    uint32_t             reserved0[4];
    struct imx28_reg_32  reset;
    struct imx28_reg_32  debug;
    struct imx28_reg_32  thermal;
    struct imx28_reg_32  usb1ctrl;
    struct imx28_reg_32  special;
    struct normal_reg_32 version;
    struct imx28_reg_32  anaclkctrl;
    struct imx28_reg_32  refctrl;
};
...
#define POWER_5VCTRL_VBUSDROOP_TRSH_MASK       (3 << 30)
#define POWER_5VCTRL_VBUSDROOP_TRSH_OFFSET     30
#define POWER_5VCTRL_VBUSDROOP_TRSH_4V3        (0 << 30)
#define POWER_5VCTRL_VBUSDROOP_TRSH_4V4        (1 << 30)
#define POWER_5VCTRL_VBUSDROOP_TRSH_4V5        (2 << 30)
#define POWER_5VCTRL_VBUSDROOP_TRSH_4V7        (3 << 30)
#define POWER_5VCTRL_HEADROOM_ADJ_MASK         (7 << 24)
#define POWER_5VCTRL_HEADROOM_ADJ_OFFSET       24
#define POWER_5VCTRL_PWD_CHARGE_4P2_MASK       (3 << 20)
...
#define POWER_5VCTRL_VBUSVALID_TRSH_MASK       (7 << 8)
#define POWER_5VCTRL_VBUSVALID_TRSH_OFFSET     8
#define POWER_5VCTRL_VBUSVALID_TRSH_2V9        (0 << 8)
#define POWER_5VCTRL_VBUSVALID_TRSH_4V0        (1 << 8)
#define POWER_5VCTRL_VBUSVALID_TRSH_4V1        (2 << 8)
#define POWER_5VCTRL_VBUSVALID_TRSH_4V2        (3 << 8)
#define POWER_5VCTRL_VBUSVALID_TRSH_4V3        (4 << 8)
#define POWER_5VCTRL_VBUSVALID_TRSH_4V4        (5 << 8)
#define POWER_5VCTRL_VBUSVALID_TRSH_4V5        (6 << 8)
#define POWER_5VCTRL_VBUSVALID_TRSH_4V6        (7 << 8)
...
#define POWER_CHARGE_ADJ_VOLT_MASK        (7 << 24)
#define POWER_CHARGE_ADJ_VOLT_OFFSET      24
#define POWER_CHARGE_ADJ_VOLT_M025P       (1 << 24)
#define POWER_CHARGE_ADJ_VOLT_P050P       (2 << 24)
#define POWER_CHARGE_ADJ_VOLT_M075P       (3 << 24)
#define POWER_CHARGE_ADJ_VOLT_P025P       (4 << 24)
#define POWER_CHARGE_ADJ_VOLT_M050P       (5 << 24)
#define POWER_CHARGE_ADJ_VOLT_P075P       (6 << 24)
#define POWER_CHARGE_ADJ_VOLT_M100P       (7 << 24)
...
#define POWER_CHARGE_STOP_ILIMIT_10MA     (1 << 8)
#define POWER_CHARGE_STOP_ILIMIT_20MA     (2 << 8)
#define POWER_CHARGE_STOP_ILIMIT_50MA     (4 << 8)
#define POWER_CHARGE_STOP_ILIMIT_100MA    (8 << 8)
...
#define POWER_VDDDCTRL_LINREG_OFFSET_MASK          (3 << 16)
#define POWER_VDDDCTRL_LINREG_OFFSET_OFFSET        16
#define POWER_VDDDCTRL_LINREG_OFFSET_0STEPS        (0 << 16)
#define POWER_VDDDCTRL_LINREG_OFFSET_1STEPS_ABOVE  (1 << 16)
#define POWER_VDDDCTRL_LINREG_OFFSET_1STEPS_BELOW  (2 << 16)
#define POWER_VDDDCTRL_LINREG_OFFSET_2STEPS_BELOW  (3 << 16)
#define POWER_VDDDCTRL_BO_OFFSET_MASK              (7 << 8)
...
#define POWER_VDDACTRL_LINREG_OFFSET_MASK          (3 << 12)
#define POWER_VDDACTRL_LINREG_OFFSET_OFFSET        12
#define POWER_VDDACTRL_LINREG_OFFSET_0STEPS        (0 << 12)
#define POWER_VDDACTRL_LINREG_OFFSET_1STEPS_ABOVE  (1 << 12)
#define POWER_VDDACTRL_LINREG_OFFSET_1STEPS_BELOW  (2 << 12)
#define POWER_VDDACTRL_LINREG_OFFSET_2STEPS_BELOW  (3 << 12)
#define POWER_VDDACTRL_BO_OFFSET_MASK              (7 << 8)
...
#define POWER_VDDIOCTRL_LINREG_OFFSET_MASK          (3 << 12)
#define POWER_VDDIOCTRL_LINREG_OFFSET_OFFSET        12
#define POWER_VDDIOCTRL_LINREG_OFFSET_0STEPS        (0 << 12)
#define POWER_VDDIOCTRL_LINREG_OFFSET_1STEPS_ABOVE  (1 << 12)
#define POWER_VDDIOCTRL_LINREG_OFFSET_1STEPS_BELOW  (2 << 12)
#define POWER_VDDIOCTRL_LINREG_OFFSET_2STEPS_BELOW  (3 << 12)
#define POWER_VDDIOCTRL_BO_OFFSET_MASK              (7 << 8)
...
#define POWER_VDDMEMCTRL_BO_OFFSET_MASK    (7 << 5)
...
#define POWER_DCDC4P2_DROPOUT_CTRL_200MV            (3 << 30)
#define POWER_DCDC4P2_DROPOUT_CTRL_100MV            (2 << 30)
#define POWER_DCDC4P2_DROPOUT_CTRL_50MV             (1 << 30)
#define POWER_DCDC4P2_DROPOUT_CTRL_25MV             (0 << 30)
#define POWER_DCDC4P2_DROPOUT_CTRL_SRC_4P2          (0 << 28)
#define POWER_DCDC4P2_DROPOUT_CTRL_SRC_4P2_LT_BATT  (1 << 28)
#define POWER_DCDC4P2_DROPOUT_CTRL_SRC_SEL          (2 << 28)
#define POWER_DCDC4P2_ISTEAL_THRESH_MASK            (3 << 24)
...
#define POWER_DCDC4P2_TRG_MASK                      (7 << 16)
#define POWER_DCDC4P2_TRG_OFFSET                    16
#define POWER_DCDC4P2_TRG_4V2                       (0 << 16)
#define POWER_DCDC4P2_TRG_4V1                       (1 << 16)
#define POWER_DCDC4P2_TRG_4V0                       (2 << 16)
#define POWER_DCDC4P2_TRG_3V9                       (3 << 16)
#define POWER_DCDC4P2_TRG_BATT                      (4 << 16)
...
#define POWER_MISC_FREQSEL_MASK          (7 << 4)
#define POWER_MISC_FREQSEL_OFFSET        4
#define POWER_MISC_FREQSEL_20MHZ         (1 << 4)
#define POWER_MISC_FREQSEL_24MHZ         (2 << 4)
#define POWER_MISC_FREQSEL_19MHZ         (3 << 4)
#define POWER_MISC_FREQSEL_14MHZ         (4 << 4)
#define POWER_MISC_FREQSEL_18MHZ         (5 << 4)
#define POWER_MISC_FREQSEL_21MHZ         (6 << 4)
#define POWER_MISC_FREQSEL_17MHZ         (7 << 4)
...
#define POWER_LOOPCTRL_EN_RCSCALE_MASK    (3 << 12)
#define POWER_LOOPCTRL_EN_RCSCALE_OFFSET  12
#define POWER_LOOPCTRL_EN_RCSCALE_DIS     (0 << 12)
#define POWER_LOOPCTRL_EN_RCSCALE_2X      (1 << 12)
#define POWER_LOOPCTRL_EN_RCSCALE_4X      (2 << 12)
#define POWER_LOOPCTRL_EN_RCSCALE_8X      (3 << 12)
#define POWER_LOOPCTRL_DC_FF_MASK         (7 << 8)
#define POWER_LOOPCTRL_DC_FF_OFFSET       8
#define POWER_LOOPCTRL_DC_R_MASK          (0xf << 4)
#define POWER_LOOPCTRL_DC_R_OFFSET        4
#define POWER_LOOPCTRL_DC_C_MASK          3
#define POWER_LOOPCTRL_DC_C_OFFSET        0
#define POWER_LOOPCTRL_DC_C_MAX           0
#define POWER_LOOPCTRL_DC_C_2X            1
#define POWER_LOOPCTRL_DC_C_4X            2
#define POWER_LOOPCTRL_DC_C_MIN           3
...
#define POWER_STS_PSWITCH_MASK               (3 << 20)
...
#define POWER_SPEED_STATUS_SEL_MASK       (3 << 6)
#define POWER_SPEED_STATUS_SEL_OFFSET     6
#define POWER_SPEED_STATUS_SEL_DCDC_STAT  (0 << 6)
#define POWER_SPEED_STATUS_SEL_CORE_STAT  (1 << 6)
#define POWER_SPEED_STATUS_SEL_ARM_STAT   (2 << 6)
#define POWER_SPEED_CTRL_MASK             3
#define POWER_SPEED_CTRL_OFFSET           0
#define POWER_SPEED_CTRL_SS_OFF           0
#define POWER_SPEED_CTRL_SS_ON            1
#define POWER_SPEED_CTRL_SS_ENABLE        3
...
#define POWER_THERMAL_OFFSET_ADJ_MASK        (3 << 4)
#define POWER_THERMAL_OFFSET_ADJ_OFFSET      4
#define POWER_THERMAL_OFFSET_ADJ_ENABLE      (1 << 3)
#define POWER_THERMAL_TEMP_THRESHOLD_MASK    7
...
#define POWER_ANACLKCTRL_OUTDIV_MASK         (7 << 28)
...
#define POWER_ANACLKCTRL_INCLK_SHIFT_MASK    (3 << 4)
#define POWER_ANACLKCTRL_INCLK_SHIFT_OFFSET  4
#define POWER_ANACLKCTRL_INDIV_MASK          7
...
#define POWER_REFCTRL_VBG_ADJ_MASK       (7 << 20)
#define POWER_REFCTRL_VBG_ADJ_OFFSET     20
#define POWER_REFCTRL_LOW_PWR            (1 << 19)
#define POWER_REFCTRL_BIAS_CTRL_MASK     (3 << 16)
